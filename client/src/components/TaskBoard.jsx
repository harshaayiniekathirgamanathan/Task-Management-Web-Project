...
// Hard-coded tasks used until the backend is connected
const dummyTasks = [
    {
        id: 1,
        ...
        labels: [{ id: 201, name: 'Backend', color: '#dc3545' }]
    },
    {
        id: 2,
        ...
        labels: [{ id: 202, name: 'UI', color: '#0d6efd' }]
    },
    {
        id: 3,
        ...
        due_date: '2023-10-25',
        assignees: [{ id: 101, name: 'Alice Smith' }],
        labels: [{ id: 203, name: 'Security', color: '#198754' }]
    },
    {
        id: 4,
        title: 'Create Layout',
        ...
        labels: [{ id: 204, name: 'Frontend', color: '#0dcaf0' }]
    },
    {
        id: 5,
        title: 'Initial Setup',
        ...
        due_date: '2023-10-20',
        assignees: [{ id: 102, name: 'Bob Jones' }],
        labels: [{ id: 205, name: 'Config', color: '#6c757d' }]
    }
];
